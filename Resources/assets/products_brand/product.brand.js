...
let $name = document.querySelector("input[data-lang='brand_form_trans_" + $lang + "']");
...
if ($name) {
    ...
    function catUrl() {
        ...
        document.getElementById('brand_form_info_url').value = translitRuEn(this.value).toLowerCase();
    }
}